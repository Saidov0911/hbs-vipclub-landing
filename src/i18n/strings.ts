...
const uz: Dict = {
  ...
  "join.subtitle": "VIP Clubga Telegram bot orqali a’zo bo‘lish mumkin.",
  "join.1.title": "Ro‘yxatdan o‘ting",
  "join.1.desc": "Telegram bot orqali tezkor ro‘yxatdan o‘tasiz.",
  "join.2.title": "Telegram botga kiring",
  "join.2.desc": "Bot sizni qadam-baqadam yo‘naltiradi.",
  "join.3.title": "To‘lovni amalga oshiring",
  "join.3.desc": "Qulay usul orqali oylik yoki yillik obunani tanlaysiz.",
  "join.4.title": "HBS VIP Club yopiq guruhiga qo‘shiling",
  "join.4.desc": "Ichkariga kirib, hamjamiyat bilan birga rivojlanasiz.",
  ...
  "price.monthly": "Oylik",
  "price.monthly.amount": "49 000 so‘m",
  "price.monthly.unit": "/ oy",
  "price.yearly": "Yillik",
  "price.yearly.amount": "450 000 so‘m",
  "price.yearly.unit": "/ yil",
  "price.yearly.badge": "Tejamkor",
  "price.trial": "Bepul sinov muddati mavjud",
